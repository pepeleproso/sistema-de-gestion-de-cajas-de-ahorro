	...
	EXTRACION.
      ...
      *cargo importe
		...
		ACCEPT IMPORTE LINE 7 COL 32 NO BEEP LOW
		COMPUTE IMPORTE-OP = SALDO - IMPORTE
		IF IMPORTE-OP < 0 THEN
		...
		END-PERFORM
      *TODO::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
      *preguntar si desea retirar ese monto??
		MOVE IMPORTE TO IMPORTE-OP.
		COMPUTE IMPORTE = 0 - IMPORTE.
		COMPUTE SALDO = SALDO + IMPORTE.
		REWRITE REG-CUENTA.
